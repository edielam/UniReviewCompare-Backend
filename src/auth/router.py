...
from src.auth.model import User ,VerifyOtpInput,LoginInput,ResetPassWordInput,ForgotPasswordInput,ResetPasswordOtpInput,UpdateProfileInput
...
async def verify_otp(verifyotpinput: VerifyOtpInput):
    return await service.verify_otp(verifyotpinput.__dict__["email"],verifyotpinput.__dict__["otp"])
